"""
메인 엔트리 포인트
/home/katech/Robot-Polishing-RL-system/py_rl 경로에서 python3 -m pid_gain_rl 실행
"""
import numpy as np
import torch
...
def main():
    ...
    config = create_config(RECV_FREQUENCY_HZ, EPISODE_LENGTH_SECONDS) # 설정 객체 생성
    ...
    # 재현성을 위한 시드 설정, NumPy, PyTorch, CUDA 시드 고정
    np.random.seed(42)
